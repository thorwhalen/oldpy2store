"""The oldpy2store wrapper to nltk.corpus.wordnet. Your no fuss gateway to (English) words.
...
Here we put a oldpy2store wrapper around this stuff.
...
from oldpy2store.sources import Attrs
from oldpy2store import Store, KvReader, cached_keys, add_ipython_key_completions
...
class KvSynset(wordnet_element_store_base(Synset)):
    ...
    For a list (or rather "dict") of these, checkout ``oldpy2store.ext.wordnet.Synsets``
