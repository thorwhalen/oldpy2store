...
warn(f"This module has moved to https://github.com/otosense/hear. You can also do `pip install hear`. "
     f"Note that a copy of the original oldpy2store.ext.audio will be kept in "
     f"https://github.com/otosense/hear/blob/master/hear/scrap/old_oldpy2store_ext_audio.py "
     f"for awhile, for those who need it.",
     DeprecationWarning)

from io import BytesIO
from oldpy2store.stores.local_store import LocalBinaryStore
from oldpy2store.trans import add_wrapper_method
...
# from oldpy2store.mint import wraps, _empty_func
...
from oldpy2store import FilesOfZip, filt_iter
...
from oldpy2store.stores.local_store import MakeMissingDirsStoreMixin
import os
