...
from oldpy2store.base import KvReader, KvPersister, Collection
...
#   (e.g. see existing oldpy2store.store.s3_store and rewrite versions of those stores that use the
#   present new way)
...
# from oldpy2store.persisters.s3_w_boto3 import S3BucketPersister
