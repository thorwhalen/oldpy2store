...
# TODO: Make oldpy2store types to handle Redis value types in a consistent matter
"""Type	Commands
...
"""See 729 - oldpy2store - Redis note book to see how to generate the following:
