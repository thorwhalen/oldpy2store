...
from oldpy2store.base import KvReader, KvPersister
from oldpy2store.filesys import FileCollection
from oldpy2store.util import lazyprop, fullpath
...
class ZipReader(KvReader):
    ...
    But you might find it useful to remove them from view. One choice is to use `oldpy2store.trans.filt_iter`
...
def mk_flatzips_store(dir_of_zips, zip_pair_path_preproc=sorted,
    ...
    """
    from oldpy2store.utils.explicit import ExplicitKeymapReader
...
from oldpy2store.util import partialclass
...
# TODO: What if I just want to zip a (single) file. What does oldpy2store offer for that?
...
# trans alternative:
# from oldpy2store.trans import mk_kv_reader_from_kv_collection, wrap_kvs
#
...
#     from oldpy2store.test.simple import test_local_file_ops
#
#     test_local_file_ops()
