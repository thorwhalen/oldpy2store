...
from oldpy2store.trans import kv_wrap_persister_cls

# from oldpy2store.utils.signatures import Sig
...
class ConfigStore(ConfigParserStore):
    ...
    >>> import os
    >>> from oldpy2store.slib.s_configparser import ConfigStore, ConfigReader
...
class ConfigReader(ConfigStore):
    ...
    >>> from oldpy2store.slib.s_configparser import ConfigReader
    >>>
    >>> # from a (pretend) file
    >>> from io import BytesIO, StringIO
    ...
    >>> from oldpy2store.slib.s_configparser import _test_config_str
