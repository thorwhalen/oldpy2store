...
from oldpy2store.base import Collection, KvReader
from oldpy2store.trans import kv_wrap
from oldpy2store.key_mappers.paths import PrefixRelativizationMixin
from oldpy2store.util import max_common_prefix
...
class ExplicitKeys(Collection):
    """
    oldpy2store.base.Keys implementation that gets it's keys explicitly from a collection given at initialization time.
