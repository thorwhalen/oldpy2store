...
from oldpy2store.base import Store, Persister
from oldpy2store.core import PrefixRelativizationMixin, PrefixRelativization
from oldpy2store.key_mappers.paths import mk_relative_path_store
from oldpy2store.serializers.pickled import mk_pickle_rw_funcs
from oldpy2store.persisters.local_files import (
    PathFormatPersister,
    DirpathFormatKeys,
    DirReader,
    ensure_slash_suffix,
)
# from oldpy2store.filesys import DirCollection
from oldpy2store.mixins import SimpleJsonMixin
...
class LocalPickleStore(RelativePathFormatStore):
    ...
    def for_dill(
        ...
        from oldpy2store.serializers.pickled import mk_dill_rw_funcs
...
class DirStore(Store):
    ...
    >>> from oldpy2store import __file__
    >>> import os
